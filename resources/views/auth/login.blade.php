<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <x-primary-button class="flex justify-center w-full mt-1">
            {{ __('Log in') }}
        </x-primary-button>
        ...
        <div class="flex items-center justify-center gap-2 px-4 py-2 my-5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
